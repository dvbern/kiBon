...
<div>
	...
	<p>
		Der Antrag mit der Fallnummer <a href="${frontendUrl}/gesuch/verfuegen/${gesuch.id}">${gesuch.dossier.fall.fallNummer?string("#")}</a> wurde bestätigt. Es können nun auch die
