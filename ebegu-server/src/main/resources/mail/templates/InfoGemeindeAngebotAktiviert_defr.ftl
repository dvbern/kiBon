...
To: ${empfaengerMail}
Subject: <@base64Header>kiBon <#if configuration.isDevmode>Testsystem</#if> – Angebot ${angebotNameDe} wurde aktiviert / L'offre ${angebotNameFr} a été activée </@base64Header>
