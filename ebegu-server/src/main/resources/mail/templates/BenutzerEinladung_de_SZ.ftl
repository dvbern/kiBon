...
<div>
	...
	<ol type="1">
		...
		<li>Melden Sie sich mit dem folgenden Initialpasswort an: ${eingeladener.getInitialPassword()}</li>
        </#if>
		<li>Geben Sie Ihre Daten ein. Die Mobiltelefonnummer wird für die 2-Faktor-Authentifizierung benötigt.</li>
