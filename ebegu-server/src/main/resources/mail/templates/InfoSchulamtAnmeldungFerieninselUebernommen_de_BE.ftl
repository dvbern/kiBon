...
<div>
	...
	<p>
		...
		.name} wurde entgegengenommen. Sie erhalten die definitive Bestätigung der Anmeldung direkt von der Institution. <br/>
		Die gewählten Module können <a href="${frontendUrl}/gesuch/verfuegen/${betreuung.extractGesuch().id}">hier</a> eingesehen werden.
	</p>
	<p>
