...
public class MutationsMergerFinanzielleSituationBernFKJVTest {
	...
	private static final MutationsMergerFinanzielleSituationBernFKJV MUTATIONS_MERGER_FINANZIELLE_SITUATION_BERN_FKJV =
		new MutationsMergerFinanzielleSituationBernFKJV(
			Locale.GERMAN
		);
	...
	@Test
	void test_kleinereMassgegebeneseinkommens_Familiengroesse_aendert_nicht_nur_massgegebenes() {
		...
		MUTATIONS_MERGER_FINANZIELLE_SITUATION_BERN_FKJV.handleEinkommen(
			bgCalculationInput,
			resultVorgaenger,
			prepareBetreuung(
				HUNDERT_TAUSEND,
	...
	@Test
	void test_hoereMassgegebeneseinkommens_Familiengroesse_aendert_nicht_nur_massgegebenes() {
		BGCalculationInput bgCalculationInput = initInputData(
			ZWEI_HUNDERT_TAUSEND,
			THREE
		);
