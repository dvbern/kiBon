...
class MutationsMergerAnspruchHandlerTest extends
	AbstractDefaultMutationsMergerAnspruchHandlerTest {

	static final MutationsMergerAnspruchHandler MUTATIONS_MERGER_ANSPRUCH_HANDLER_DEFAULT =
		new MutationsMergerAnspruchHandler(
			Locale.GERMAN
		);
