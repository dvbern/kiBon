...
public abstract class AbstractMutationsMergerAnspruchVorgaengerHandlerTest {
	//01.09.XXXX
	...
	protected AbstractMutationsMergerAnspruchVorgaengerHandler mutationsMergerAnspruchVorgaengerHandler;

	protected abstract AbstractMutationsMergerAnspruchVorgaengerHandler createHandler();

	@BeforeEach
	void setup() {
		mutationsMergerAnspruchVorgaengerHandler = createHandler();
	}
	...
	void test_hoere_anspruchspensumProzent_MutationGleicheMonat_keineaenderung() {
		...
		mutationsMergerAnspruchVorgaengerHandler.handleAnpassungAnspruch(
			bgCalculationInput,
			resultVorgaenger,
	...
	protected BGCalculationInput initInputData(int anspruchspensumProzent) {
	...
	protected BGCalculationResult initResultData(int anspruchspensumProzent) {
