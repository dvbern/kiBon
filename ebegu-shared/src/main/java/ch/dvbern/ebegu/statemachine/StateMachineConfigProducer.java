...
@SuppressWarnings({ "ClassNamePrefixedWithPackageName",
	"PMD.UnusedFormalParameter", "VisibilityModifier" })
@Dependent
public class StateMachineConfigProducer {

	private final StateMachineConfig<AntragStatus, AntragEvents> gesuchFSMConfig =
	...
	public StateMachineConfig<AntragStatus, AntragEvents> createStateMachineConfig() {
		...
		gesuchFSMConfig.configure(AntragStatus.IN_BEARBEITUNG_GS)
			.permit(
				AntragEvents.FREIGABEQUITTUNG_ERSTELLEN,
		...
		gesuchFSMConfig.configure(AntragStatus.GEPRUEFT)
			.permit(
				AntragEvents.ZUWEISUNG_SCHULAMT,
				AntragStatus.NUR_SCHULAMT
			)
			.permit(AntragEvents.VERFUEGUNG_STARTEN, AntragStatus.VERFUEGEN)
			.permit(
				AntragEvents.VERFUEGEN_OHNE_ANGEBOT,
				AntragStatus.KEIN_ANGEBOT
			)
			.permit(
				AntragEvents.KEIN_KONTINGENT,
				AntragStatus.KEIN_KONTINGENT
			)
			.permit(AntragEvents.IGNORIEREN, AntragStatus.IGNORIERT);
		...
		gesuchFSMConfig.configure(AntragStatus.BESCHWERDE_HAENGIG)
			.permit(
				AntragEvents.ZURUECK_NUR_SCHULAMT,
				AntragStatus.NUR_SCHULAMT
			)
			.permit(AntragEvents.ZURUECK_VERFUEGT, AntragStatus.VERFUEGT)
			.permit(
				AntragEvents.ZURUECK_KEIN_ANGEBOT,
				AntragStatus.KEIN_ANGEBOT
			)
			.permit(
				AntragEvents.ZURUECK_PRUEFUNG_STV,
				AntragStatus.PRUEFUNG_STV
			)
			.permit(
				AntragEvents.ZURUECK_IN_BEARBEITUNG_STV,
				AntragStatus.IN_BEARBEITUNG_STV
			)
			.permit(
				AntragEvents.ZURUECK_GEPRUEFT_STV,
		...
		gesuchFSMConfig.configure(AntragStatus.PRUEFUNG_STV)
			...
			.permit(
				AntragEvents.ERSTES_OEFFNEN_STV,
				AntragStatus.IN_BEARBEITUNG_STV
			)
			.permit(
				AntragEvents.PRUEFUNG_STV_JA_ABGESCHLOSSEN,
				AntragStatus.NUR_SCHULAMT
			)
			.permit(
				AntragEvents.PRUEFUNG_STV_SCH_ABGESCHLOSSEN,
		...
		gesuchFSMConfig.configure(AntragStatus.ERSTE_MAHNUNG)
			.permit(
				AntragEvents.MAHNUNG_ABGELAUFEN,
				AntragStatus.ERSTE_MAHNUNG_ABGELAUFEN
			)
			.permit(
				AntragEvents.MAHNLAUF_BEENDEN,
				AntragStatus.IN_BEARBEITUNG_JA
			);
		...
		gesuchFSMConfig.configure(AntragStatus.ZWEITE_MAHNUNG)
			.permit(
				AntragEvents.MAHNUNG_ABGELAUFEN,
				AntragStatus.ZWEITE_MAHNUNG_ABGELAUFEN
			)
			.permit(
				AntragEvents.MAHNLAUF_BEENDEN,
				AntragStatus.IN_BEARBEITUNG_JA
