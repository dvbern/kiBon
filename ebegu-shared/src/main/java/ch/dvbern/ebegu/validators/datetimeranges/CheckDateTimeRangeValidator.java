...
package ch.dvbern.ebegu.validators.datetimeranges;
...
public class CheckDateTimeRangeValidator implements
	ConstraintValidator<CheckDateTimeRange, DateTimeRange> {
	...
	public boolean isValid(
		@Nonnull DateTimeRange instance,
