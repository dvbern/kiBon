...
public final class DokumentUebernehmenCalculator {

	public static List<DokumentGrund> calculateGrundeZuUbernehmen(
		...
		return dokumentGrundeVorjahr.stream()
			.filter(
				potentialGrundFromVorjahr -> allowedDokumentTypsZuUebernehmen
