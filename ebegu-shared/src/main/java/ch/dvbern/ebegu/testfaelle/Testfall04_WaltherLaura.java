...
public class Testfall04_WaltherLaura extends AbstractTestfall {
	...
	public Gesuch fillInGesuch() {
		...
		KindContainer kind1 = createKind(
			...
			FAMILIENNAME,
			"Lorenz",
			LocalDate.of(2013, Month.FEBRUARY, 17),
		...
		Betreuung betreuungTagiAaregg = createBetreuung(
			institutionStammdatenBuilder
		...
		betreuungTagiAaregg.getBetreuungspensumContainers()
		...
		finanzielleSituationGS1.getFinanzielleSituationJA()
			.setSchulden(
				Objects.requireNonNull(MathUtil.DEFAULT.from(451248))
			);
		...
		finanzielleSituationGS2.getFinanzielleSituationJA()
			.setGeschaeftsgewinnBasisjahr(
				Objects.requireNonNull(MathUtil.DEFAULT.from(48023))
			);
		finanzielleSituationGS2.getFinanzielleSituationJA()
			.setGeschaeftsgewinnBasisjahrMinus1(
				MathUtil.DEFAULT.from(54871)
			);
		finanzielleSituationGS2.getFinanzielleSituationJA()
			.setGeschaeftsgewinnBasisjahrMinus2(
				MathUtil.DEFAULT.from(46017)
			);
