...
public class Testfall_ASIV_04 extends AbstractASIVTestfall {
	...
	public Gesuch createMutation(Gesuch erstgesuch) {
		...
		erstgesuch.getGesuchsteller1()
			.setEinkommensverschlechterungContainer(ekvContainer);
		// Einkommensverschlechterug
		...
		ekvContainerGS2.getEkvJABasisJahrPlus1()
			.setNettolohn(MathUtil.DEFAULT.from(0));
		Objects.requireNonNull(erstgesuch.getGesuchsteller2());
		erstgesuch.getGesuchsteller2()
			.setEinkommensverschlechterungContainer(ekvContainerGS2);
		return erstgesuch;
	}
