...
public interface GeneratedDokumentService {
	 ...
	 */
	@Nonnull
	WriteProtectedDokument saveDokument(
		@Nonnull WriteProtectedDokument dokument
	);

	@Nullable
	WriteProtectedDokument findGeneratedDokument(
		@Nonnull String gesuchId,
		@Nonnull String filename
	);

	@Nullable
	Pain001Dokument findPain001Dokument(
		@Nonnull String zahlungsauftragId,
		@Nonnull String filename
	);

	@Nonnull
	WriteProtectedDokument saveGeneratedDokumentInDB(
		@Nonnull byte[] data,
	...
	@Nonnull
	WriteProtectedDokument getFinSitDokumentAccessTokenGeneratedDokument(
	...
	@Nonnull
	WriteProtectedDokument getBegleitschreibenDokument(
		@Nonnull Gesuch gesuch,
		@Nonnull Boolean forceCreation
	)
		throws MimeTypeParseException, MergeDocException;
	...
	@Nonnull
	WriteProtectedDokument getKompletteKorrespondenz(@Nonnull Gesuch gesuch)
		throws MimeTypeParseException, MergeDocException;

	@Nonnull
	WriteProtectedDokument getFreigabequittungAccessTokenGeneratedDokument(
		@Nonnull Gesuch gesuch,
		@Nonnull Boolean forceCreation
	)
		throws MimeTypeParseException, MergeDocException;
	...
	@Nonnull
	WriteProtectedDokument getVerfuegungDokumentAccessTokenGeneratedDokument(
		@Nonnull Gesuch gesuch,
		@Nonnull Betreuung betreuung,
		@Nonnull String manuelleBemerkungen,
		@Nonnull Boolean forceCreation
	) throws MimeTypeParseException, MergeDocException, IOException;

	@Nonnull
	WriteProtectedDokument getMahnungDokumentAccessTokenGeneratedDokument(
	...
	@Nonnull
	WriteProtectedDokument getNichteintretenDokumentAccessTokenGeneratedDokument(
		@Nonnull Betreuung betreuung,
		@Nonnull Boolean forceCreation
	)
		throws MimeTypeParseException, IOException, MergeDocException;
	...
	@Nonnull
	WriteProtectedDokument getPain001DokumentAccessTokenGeneratedDokument(
		@Nonnull Zahlungsauftrag zahlungsauftrag
	)
		throws MimeTypeParseException;

	@Nonnull
	WriteProtectedDokument getInfomaDokumentAccessTokenGeneratedDokument(
		@Nonnull Zahlungsauftrag zahlungsauftrag
	)
		throws MimeTypeParseException;

	void createZahlungsFiles(@Nonnull Zahlungsauftrag zahlungsauftrag)
		throws MimeTypeParseException;

	void removeAllGeneratedDokumenteFromGesuch(@Nonnull Gesuch gesuch);

	@Nonnull
	Collection<GeneratedDokument> findGeneratedDokumentsFromGesuch(
		@Nonnull Gesuch gesuch
	);
