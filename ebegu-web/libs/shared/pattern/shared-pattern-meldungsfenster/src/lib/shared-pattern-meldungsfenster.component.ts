...
import {tsBrowserLanguageFromString} from '@kibon/shared/model/enums';
import {browserLanguageToSprache, TSSprache} from '@kibon/shared/model/enums';
...
@Component({
    ...
    templateUrl: './shared-pattern-meldungsfenster.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SharedPatternMeldungsfensterComponent {
