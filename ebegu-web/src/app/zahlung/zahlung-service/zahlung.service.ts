...
import {TSZahlung, TSZahlungsauftrag, TSZahlungslaufTyp} from '@models/zahlung';
...
const LOG = LogFactory.createLog('ZahlungService');
...
export class ZahlungService {
    ...
    public getZahlungsauftraegeForRole$(
        ...
        const searchParams = ZahlungService.getSearchParams(
            sort,
            page,
            pageSize,
            filterGemeinde,
