...
UPDATE einstellung set value = '0.6' WHERE einstellung_key = 'GEMEINDE_PAUSCHALBETRAG_HOHE_EINKOMMENSKLASSEN_BETRAG_TFO_AB_PRIMARSCHULE' AND gesuchsperiode_id = @gesuchsperiode_22_23_id AND gemeinde_id is null;
UPDATE einstellung set value = '160000' WHERE einstellung_key = 'GEMEINDE_PAUSCHALBETRAG_HOHE_EINKOMMENSKLASSEN_MAX_MASSGEBENDEN_EINKOMMEN_FUER_BERECHNUNG' AND gesuchsperiode_id = @gesuchsperiode_22_23_id AND gemeinde_id is null;
...
INSERT IGNORE INTO einstellung(id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, einstellung_key, value, gemeinde_id, gesuchsperiode_id, mandant_id, erklaerung) SELECT UUID(), now(), now(), 'ebegu:Kanton Solothurn', 'ebegu:Kanton Solothurn', 0, 'GEMEINDE_PAUSCHALBETRAG_HOHE_EINKOMMENSKLASSEN_BETRAG_TFO_AB_PRIMARSCHULE', '0.6', @testgemeinde_grenchen_id, @gesuchsperiode_22_23_id, @mandant_id_solothurn, null;
