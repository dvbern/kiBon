...
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_bern, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');

# appenzell
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_ar, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');

# solothurn
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_solothurn, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');

# luzern
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_luzern, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');

# schwyz
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_schwyz, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');

# dvb
INSERT INTO application_property (id, mandant_id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, vorgaenger_id, name, value)
VALUES (UNHEX(REPLACE(UUID(), '-', '')), @mandant_id_dvb, now(), now(), 'flyway', 'flyway', 0, null, 'ABGELOESTE_VIEW', 'false');
