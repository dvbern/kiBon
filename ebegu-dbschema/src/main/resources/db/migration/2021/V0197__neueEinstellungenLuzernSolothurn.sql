...
INSERT INTO einstellung (id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, einstellung_key, value, gesuchsperiode_id)
    (
        SELECT UNHEX(REPLACE(UUID(), '-', '')) as id,
            ...
            '0' as version,
            'KITAPLUS_ZUSCHLAG_AKTIVIERT' as einstellungkey,
            'false' as value,
...
INSERT INTO einstellung (id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, einstellung_key, value, gesuchsperiode_id)
    (
        SELECT UNHEX(REPLACE(UUID(), '-', '')) as id,
            ...
            'ebegu' as user_mutiert,
            '0' as version,
            'GEMEINDESPEZIFISCHE_BG_KONFIGURATIONEN' as einstellungkey,
            'false' as value,
            id as gesuchsperiode_id
        FROM gesuchsperiode
    );
...
INSERT INTO einstellung (id, timestamp_erstellt, timestamp_mutiert, user_erstellt, user_mutiert, version, einstellung_key, value, gesuchsperiode_id)
    (
        SELECT UNHEX(REPLACE(UUID(), '-', '')) as id,
            ...
            'ebegu' as user_mutiert,
            '0' as version,
            'ANSPRUCH_UNABHAENGIG_BESCHAEFTIGUNGPENSUM' as einstellungkey,
            'false' as value,
            id as gesuchsperiode_id
        FROM gesuchsperiode
    );
